#!/bin/bash
base_data='/home/timo/Data2/mvsec/data/'

num_indoor_flying_bags=4

bagnames[1]=indoor_flying1_data
bagnames[2]=indoor_flying2_data
bagnames[3]=indoor_flying3_data
bagnames[4]=indoor_flying4_data
...
outdoor_day_bag_dir="$base_data"
#num_outdoor_day_bags=2
num_outdoor_day_bags=1

outdoor_day_bagnames[1]=outdoor_day1_data
...
#outdoor_night_bag_dir="$base_data"
